...
#include "../../../../../src/reuleaux-noetic/base_placement_plugin/include/base_placement_plugin/place_base.h"
...
void PlaceBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlaceBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (PlaceBase::*)(const tf::Transform );
        ...
        {
            using _t = void (PlaceBase::*)(std::vector<std::string> );
...
QT_INIT_METAOBJECT const QMetaObject PlaceBase::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_PlaceBase.data,
    qt_meta_data_PlaceBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
