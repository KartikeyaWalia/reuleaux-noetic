...
#include "../../../../../src/reuleaux-noetic/workspace_visualization/src/capability_map_display.h"
...
void workspace_visualization::CapMapDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CapMapDisplay *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject workspace_visualization::CapMapDisplay::staticMetaObject = { {
    &rviz::MessageFilterDisplay<map_creator::capability>::staticMetaObject,
    qt_meta_stringdata_workspace_visualization__CapMapDisplay.data,
    qt_meta_data_workspace_visualization__CapMapDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
